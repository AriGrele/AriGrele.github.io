...
func final_ready():
	...
	text         = get_node("../View/CanvasLayer/CenterPanel/missinglabel")
	sprite       = get_node("../View/CanvasLayer/CenterPanel")
	zoom         = get_node("../View/CanvasLayer/CenterPanel/zoom_shader/Viewport/image")
